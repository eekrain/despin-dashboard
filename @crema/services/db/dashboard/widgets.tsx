...
const widgetsData: Widgets = {
  ...
  mateInfo: {
    facebookInfo: {
      image: '${process.env.NEXT_PUBLIC_BASE_PATH}/images/logo-white.png',
      name: 'Crema Admin',
  ...
  temperatures: [
    {
      id: 332332,
      day: 'Mon',
      image: '${process.env.NEXT_PUBLIC_BASE_PATH}/images/weather/weather2.png',
    },
    {
      id: 3233232,
      day: 'Tues',
      image: '${process.env.NEXT_PUBLIC_BASE_PATH}/images/weather/weather3.png',
    },
    {
      id: 4343443,
      day: 'Wed',
      image: '${process.env.NEXT_PUBLIC_BASE_PATH}/images/weather/weather4.png',
    },
  ],
  cityData: [
    {
      ...
      image:
        '${process.env.NEXT_PUBLIC_BASE_PATH}/images/widgets-companyInfo/building1.png',
    },
    {
      id: 3332,
      name: 'Sydney',
      ...
      image:
        '${process.env.NEXT_PUBLIC_BASE_PATH}/images/widgets-companyInfo/building2.png',
    },
    {
      id: 4332,
      name: 'New Delhi',
      ...
      image:
        '${process.env.NEXT_PUBLIC_BASE_PATH}/images/widgets-companyInfo/building3.png',
    },
    {
      id: 5432,
      name: 'Singapore',
      ...
      image:
        '${process.env.NEXT_PUBLIC_BASE_PATH}/images/widgets-companyInfo/building4.png',
    },
  ],
};
