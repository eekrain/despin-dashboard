  ...
  drState: [
    {
      ...
      bgColor: '#0A8FDC',
      time: '9 AM',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/dentist.png`,
    },
    {
      id: 2,
      ...
      bgColor: '#00B59C',
      time: '10 AM',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/heart.png`,
    },
    {
      id: 3,
      ...
      bgColor: '#B745FF',
      time: '9 AM',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/neuro.png`,
    },
    {
      id: 4,
      ...
      bgColor: '#3A3849',
      time: '10 AM',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/pulmo.png`,
    },
  ],
  heathStatics: {
    dataOne: [
  ...
  hospitalStatics: [
    {
      ...
      value: '3,256',
      name: 'Total Patient',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-patient.png`,
    },
    {
      id: 2,
      value: '694',
      name: 'Available Staff',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-available-staff.png`,
    },
    {
      id: 3,
      value: '$4,435',
      name: 'Avg Treat Cost',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-avg-cost.png`,
    },
    {
      id: 4,
      value: '1,150',
      name: 'Available Cars',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-available-car.png`,
    },
  ],
  recentPatients: [
    {
  ...
  bloodCard: [
    {
      id: 1,
      name: 'Blood Pressure',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-blood.png`,
    ...
    },
    {
      id: 2,
      name: 'Blood Glucose',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-bloodgroup.png`,
    ...
    },
    {
      ...
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-beat.png`,
    ...
    },
    {
      id: 4,
      name: 'Immunity Rate',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-immune.png`,
      measurement: '4800 μL',
      color: '#2717A4',
    },
  ],
  appointmentCards: [
    {
      ...
      value: '1878',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-appointment.png`,
      chartValue: '2.68',
    ...
    },
    {
      ...
      name: 'Surgery',
      value: '1878',
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-surgery.png`,
      chartValue: '2.68',
      chartTime: 'Since last month',
      chartData: [
        {month: 'Jan', users: 1000},
  ...
  doses: [
    {
      ...
      icon: `${process.env.NEXT_PUBLIC_BASE_PATH}/images/dashboard/icon-vitamin.png`,
    },
    {
      id: 2,
      value: 'Immune Renew',
