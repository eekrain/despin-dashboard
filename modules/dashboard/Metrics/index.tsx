            ...
            <GridContainer>
              <Grid item xs={12} sm={6} md={3}>
                <StatsCard
                  ...
                  bgColor={red[500]}
                  icon={
                    '${process.env.NEXT_PUBLIC_BASE_PATH}/images/metricsIcons/order.png'
                  }
                />
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={3}>
                <StatsCard
                  ...
                  bgColor={blue[300]}
                  icon={
                    '${process.env.NEXT_PUBLIC_BASE_PATH}/images/metricsIcons/revenue.png'
                  }
                />
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={3}>
                <StatsCard
                  ...
                  bgColor={indigo[400]}
                  icon={
                    '${process.env.NEXT_PUBLIC_BASE_PATH}/images/metricsIcons/visits.png'
                  }
                />
              </Grid>
              ...
              <Grid item xs={12} sm={6} md={3}>
                <StatsCard
                  ...
                  bgColor={green[500]}
                  icon={
                    '${process.env.NEXT_PUBLIC_BASE_PATH}/images/metricsIcons/querries.png'
                  }
                />
              </Grid>
