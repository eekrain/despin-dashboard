    ...
    <Box>
      ...
      <Grid container spacing={isBreakPointDown('md') ? 4 : 8}>
        <Grid item xs={12} sm={6}>
          <CoinStats
            icon={'${process.env.NEXT_PUBLIC_BASE_PATH}/images/bitcoin.png'}
            bgColor={red[600]}
        ...
        <Grid item xs={12} sm={6}>
          <CoinStats
            icon={'${process.env.NEXT_PUBLIC_BASE_PATH}/images/etherium.png'}
            bgColor={blue[500]}
        ...
        <Grid item xs={12} sm={6}>
          <CoinStats
            icon={'${process.env.NEXT_PUBLIC_BASE_PATH}/images/litcoin.png'}
            bgColor={indigo[700]}
        ...
        <Grid item xs={12} sm={6}>
          <CoinStats
            icon={'${process.env.NEXT_PUBLIC_BASE_PATH}/images/ripple.png'}
            bgColor={teal[600]}
